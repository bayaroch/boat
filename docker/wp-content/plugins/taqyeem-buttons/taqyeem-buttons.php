...
function taq_button_admin_notice() {
	...
	if( ! function_exists ( 'taqyeem_init' ) ){ ?>
		<div class="error">
			<p><strong><?php _e( '&quot;Taqyeem Buttons&quot; plugin is an extension for and requires <a href="http://codecanyon.net/item/taqyeem-wordpress-review-plugin/4558799?ref=tielabs">Taqyeem Plugin</a>', 'taq' ); ?><strong></p>
		</div>
		<?php
	}
	...
	if( function_exists ( 'taqyeem_init' ) && ( !defined( 'TIE_Plugin_ver' ) || version_compare( '2.1.0' , TIE_Plugin_ver , '>') ) ){ ?>
		<div class="error">
			<p><strong><?php _e( '&quot;Taqyeem Buttons&quot; plugin requires <a href="http://codecanyon.net/item/taqyeem-wordpress-review-plugin/4558799?ref=tielabs">Taqyeem Plugin</a> Version 2.1 or above.', 'taq' ); ?><strong></p>
		</div>
		<?php
	}
}
...
function taq_buttons_admin_register() {
	...
	if( true === $load_fontawesome && get_post_type() ){ // Load the file in the add/edit posts screens
...
function tie_taqyeem_buttons_panel_tab(){ ?>
	<li class="tie-tabs buttons-addon"><a href="#taq-button-tab"><span class="taq-icon-menu dashicons-before dashicons-screenoptions taq-icon-menu"></span><?php _e('Buttons Settings','taq'); ?></a></li>
	<?php
}
...
function tie_taqyeem_button_output( $output ){
	...
	if( ! empty( $get_meta['taq_review_button_enable'][0] ) ){
		...
		$button_text = apply_filters( 'taqyeem_buttons_text', $button_text );
		$button_icon = apply_filters( 'taqyeem_buttons_icon', $button_icon );
