...
if( ! class_exists( 'TieLabs_Instagram_Graph' ) ) {

	class TieLabs_Instagram_Graph {
		...
		private function remote_get( $url = false ){
			...
			$args = array(
				'timeout'    => 30,
				'user-agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.23190.132 Safari/537.36',
			);
		...
		public function get_data(){
			...
			// Request media
			$args = array(
				'fields'       => 'media_url,thumbnail_url,caption,id,media_type,timestamp,username,permalink',
				'limit'        => 18,
			...
			$expiration = apply_filters( 'TieLabs/Instagram_Feed/Api/expiration', 4 * HOUR_IN_SECONDS );
