...
if( ! class_exists( 'ARQAM_LITE_COUNTERS' )){
	...
	class ARQAM_LITE_COUNTERS{
		...
		function __construct(){
			...
			$this->arq_transient = get_transient( 'arq_counters' ) ? get_transient( 'arq_counters' ) : array();
		...
		function facebook_count(){
			...
			$counter = ! empty( $this->arq_options['social']['facebook']['number'] ) ? $this->arq_options['social']['facebook']['number'] : 0;
		...
		function twitter_count(){
			...
			// Manual
			$counter = ( ! empty( $this->arq_options['social']['twitter']['number'] ) && empty( $counter ) ) ? $this->arq_options['social']['twitter']['number'] : 0;
		...
		function instagram_count(){
			...
			$counter = ! empty( $this->arq_options['social']['instagram']['number'] ) ? $this->arq_options['social']['instagram']['number'] : 0;
